...
public class NavigationTreeGrid extends TreeGrid {
	...
	public NavigationTreeGrid() {
		...
		data.setRoot(new TreeNode("root", new TreeNode("File", new TreeNode(
				"FileChild")), new TreeNode("Edit", new TreeNode("EditChild",
				new TreeNode("EditGrandChild"))), new TreeNode("Window")));
